  ...
  return (
    <div className="lg:flex lg:justify-between lg:gap-4">
        <header className="lg:flex lg:flex-col lg:justify-between lg:w-1/2 lg:max-h-screen lg:py-24 lg:sticky lg:top-0">
          <div>
            ...
            <nav className="mt-16 hidden lg:block" aria-label="In-page jump links">
              <ul className="w-max">
                {sections.map((section, sectionIdx) => <li key={section.href}>
                  <a href={section.href} className={`group flex items-center gap-x-4 py-3 outline-none ${sectionIdx === 0 ? 'active' : ''}`}>
                    ...
                    <span className="transition-colors uppercase text-xs text-slate-500 font-bold tracking-widest group-[.active]:text-slate-200 group-hover:text-slate-200 group-focus-visible:text-slate-200">{section.label}</span>
                  </a>
                </li>)}
              </ul>
            </nav>
          </div>
          <ul className="flex items-center gap-x-5 mt-8" aria-label="Social Media">
            <li>
            <a href="#" className="inline-block hover:text-slate-200 transition-colors" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="Github" >
            ...
            <li>
            <a href="#" className="inline-block hover:text-slate-200 transition-colors" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn" >
            ...
            <li>
            <a href="#" className="inline-block hover:text-slate-200 transition-colors" target="_blank" rel="noreferrer noopener" aria-label="Twitter (opens in a new tab)" title="Twitter" >
        ...
        <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
          <AboutSection className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" />
          <ExperienceSection className='mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24' />
          <ProjectsSection className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" />
